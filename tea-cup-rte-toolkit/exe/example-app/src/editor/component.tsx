      ...
      <div className='editor-toolbar'>
        ...
        <div className='toolbar-group'>
          <button
            ...
            onMouseDown={(e) => {
              ...
              if (linkStatus !== 'Disabled')
                dispatch({ _tag: 'ShowInsertLinkModal' })
            }}
          >
            <LinkIcon />
          </button>
          <button
            ...
            onMouseDown={(e) => {
              e.preventDefault()
              if (imageStatus !== 'Disabled')
                dispatch({ _tag: 'ShowInsertImageModal' })
            }}
          >
            <ImageIcon />
          </button>
        ...
        <div className='toolbar-group'>
          <button
            ...
            onMouseDown={(e) => {
              e.preventDefault()
              if (cs.hasSelection)
                dispatch({ _tag: 'WrapInList', listType: 'Ordered' })
            }}
          >
            <ListOlIcon />
          </button>
          <button
            ...
            onMouseDown={(e) => {
              e.preventDefault()
              if (cs.hasSelection)
                dispatch({ _tag: 'WrapInList', listType: 'Unordered' })
            }}
          >
            <ListUlIcon />
          </button>
