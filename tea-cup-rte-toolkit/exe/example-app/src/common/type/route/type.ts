...
export const SpecExtensionPageEq: EqClass.Eq<SpecExtensionPage> = EqClass.struct({
  _tag: S.Eq,
})

export const SpecFromScratchPageEq: EqClass.Eq<SpecFromScratchPage> = EqClass.struct({
  _tag: S.Eq,
})
...
export const AppPageEq: EqClass.Eq<AppPage> = {
  equals: (x, y) => {
    ...
    } else if (x._tag === 'SpecExtensionPage' && y._tag === 'SpecExtensionPage') {
      return SpecExtensionPageEq.equals(x, y)
    } else if (x._tag === 'SpecFromScratchPage' && y._tag === 'SpecFromScratchPage') {
...
export const specFromScratchPage = (): AppPage => ({ _tag: 'SpecFromScratchPage' })
