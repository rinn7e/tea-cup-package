...
import { createState, editor as createEditor, markdown } from '@rinn7e/tea-cup-rte-toolkit'
...
export const init = (): [Model, Cmd<Msg>] => {
  const [editorModel, editorCmd] = [
    EditorUpdate.init(createEditor(createState(EditorUpdate.docInitNode(), O.none))),
