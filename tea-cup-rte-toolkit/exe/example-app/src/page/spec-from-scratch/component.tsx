...
import { todoSpec, todoDecorations } from './update'
  ...
  return (
    <div>
      ...
      <p className="page-description">
        This example shows how to write a custom specification completely from scratch. 
        We define a custom <code>todo_list</code> element and interactive <code>todo_item</code> elements with checkbox toggles, complete with custom event interception to update the item's checked attribute.
      </p>
