  ...
  return (
    <div>
      <div className="home-hero">
        <h1 className="home-title">Tea-Cup package for building rich text editors</h1>
        <p className="home-subtitle">
          A robust, programmable rich text editor toolkit inspired by elm-rte-toolkit, faithfully ported to React and TypeScript.
        </p>
      </div>
      ...
      <h2 className="page-title" style={{ marginTop: '4rem', textAlign: 'center' }}>
        Features 🚀
      </h2>
      ...
      <div style={{ marginTop: '4rem', padding: '2rem', borderTop: '1px solid var(--border-color)', color: 'var(--text-secondary)' }}>
        <h2 style={{ color: 'var(--text-primary)', marginBottom: '1rem' }}>About 🌸</h2>
        <p style={{ marginBottom: '1rem' }}>
          Rich Text Editor Toolkit is an open source project that you are free to use commercially.
          The project is inspired by the wonderful work of the Elm community.
        </p>
        <p>
          Feel free to explore our examples directory to see the toolkit in action with standard, customized, and from-scratch spec models!
        </p>
      </div>
    </div>
  )
