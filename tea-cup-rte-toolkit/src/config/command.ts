...
export type CommandMap = {
  readonly _tag: 'CommandMap'
  readonly contents: CommandMapContents
}
...
export function namedCommandListFromInputEvent(
  event: InputEvent,
  map: CommandMap,
): NamedCommandList {
...
export function defaultKeyCommand(
  map: CommandMap,
): (event: KeyboardEvent) => NamedCommandList {
  return map.contents.defaultKeyCommand
}

export function defaultInputEventCommand(
  map: CommandMap,
): (event: InputEvent) => NamedCommandList {
