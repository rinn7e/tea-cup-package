...
export type Attribute =
  | {
      readonly _tag: 'StringAttribute'
      readonly key: string
      readonly value: string
    }
  | {
      readonly _tag: 'IntegerAttribute'
      readonly key: string
      readonly value: number
    }
  | {
      readonly _tag: 'BoolAttribute'
      readonly key: string
      readonly value: boolean
    }
  | {
      readonly _tag: 'FloatAttribute'
      readonly key: string
      readonly value: number
    }
...
export function findBoolAttribute(
  name: string,
...
export function findFloatAttribute(
  name: string,
  attributes: Array<Attribute>,
): Option<number> {
  for (const attr of attributes) {
...
export function findStringAttribute(
  name: string,
  attributes: Array<Attribute>,
): Option<string> {
  for (const attr of attributes) {
...
export function findIntegerAttribute(
  name: string,
  attributes: Array<Attribute>,
): Option<number> {
  for (const attr of attributes) {
...
export function replaceOrAddBoolAttribute(
  name: string,
  value: boolean,
  attributes: Array<Attribute>,
): Array<Attribute> {
...
export function replaceOrAddStringAttribute(
  name: string,
  value: string,
  attributes: Array<Attribute>,
): Array<Attribute> {
...
export function replaceOrAddIntegerAttribute(
  name: string,
  value: number,
  attributes: Array<Attribute>,
): Array<Attribute> {
...
export function replaceOrAddFloatAttribute(
  name: string,
  value: number,
  attributes: Array<Attribute>,
): Array<Attribute> {
