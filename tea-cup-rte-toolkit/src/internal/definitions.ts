...
export type ContentType =
  | {
      readonly _tag: 'BlockNodeType'
      readonly allowedGroups: Option<Set<string>>
    }
  | {
      readonly _tag: 'TextBlockNodeType'
      readonly allowedGroups: Option<Set<string>>
      readonly allowedMarks: Option<Set<string>>
    }
...
export type Element = {
  readonly _tag: 'ElementParameters'
  readonly contents: ElementParametersContents
}

export type ElementToHtml = (
  element: Element,
  children: Array<HtmlNode>,
) => HtmlNode
export type HtmlToElement = (
...
export type ElementDefinition = {
  readonly _tag: 'ElementDefinition'
  readonly contents: ElementDefinitionContents
}
...
export type MarkDefinition = {
  readonly _tag: 'MarkDefinition'
  readonly contents: MarkDefinitionContents
}
...
export function elementWithAnnotations(
...
export function elementWithAttributes(
  attrs: Array<Attribute>,
  parameters: Element,
): Element {
  return {
...
export function markWithAttributes(
  attributes_: Array<Attribute>,
  m: Mark,
): Mark {
  return {
    _tag: 'Mark',
