...
__export(index_exports, {
  CalendarTypeEq: () => CalendarTypeEq,
  CheckboxChoiceEq: () => CheckboxChoiceEq,
  CheckboxTypeEq: () => CheckboxTypeEq,
  DropdownTypeEq: () => DropdownTypeEq,
  FileEq: () => FileEq,
  FileTypeEq: () => FileTypeEq,
  FormTypeEq: () => FormTypeEq,
  FormsEq: () => FormsEq,
  ModelEq: () => ModelEq,
  PropEq: () => PropEq,
  RadioChoiceEq: () => RadioChoiceEq,
  RadioTypeEq: () => RadioTypeEq,
  TextInputVariantEq: () => TextInputVariantEq,
  TextPillTypeEq: () => TextPillTypeEq,
  TextTypeEq: () => TextTypeEq,
  addFiles: () => addFiles,
  allSelectRequired: () => allSelectRequired,
  atLeastOneSelected: () => atLeastOneSelected,
  autocompleteToString: () => autocompleteToString,
  defaultCalendarType: () => defaultCalendarType,
  defaultCheckboxType: () => defaultCheckboxType,
  defaultDropdownType: () => defaultDropdownType,
  defaultFileType: () => defaultFileType,
  defaultRadioType: () => defaultRadioType,
  defaultTextPillType: () => defaultTextPillType,
  defaultTextType: () => defaultTextType,
  emailValidator: () => emailValidator,
  exactLengthFileValidator: () => exactLengthFileValidator,
  formView: () => formView,
  fromMB: () => fromMB,
  ...
  lookupFormSafe: () => lookupFormSafe,
  maxLengthValidator: () => maxLengthValidator,
  maxSizeFileValidator: () => maxSizeFileValidator,
  minLengthValidator: () => minLengthValidator,
  noExtraValidation: () => noExtraValidation,
  nonEmptyValidator: () => nonEmptyValidator,
  notNoneValidator: () => notNoneValidator,
  notNullValidator: () => notNullValidator,
  notTheSameExtraValidation: () => notTheSameExtraValidation,
  numberValidator: () => numberValidator,
  phoneValidator: () => phoneValidator,
  runValidation: () => runValidation,
  runValidationAndLink: () => runValidationAndLink,
  runValidationForAll: () => runValidationForAll,
  showAllValidation: () => showAllValidation,
  textInputVariantToString: () => textInputVariantToString,
  textPillMsgHandler: () => textPillMsgHandler,
  uniqueFileValidator: () => uniqueFileValidator,
  unsafeModifyFormValue: () => unsafeModifyFormValue,
  update: () => update,
  updateTextPillValue: () => updateTextPillValue,
  updateValueTextType: () => updateValueTextType,
  valueCalendarType: () => valueCalendarType,
  valueCheckboxType: () => valueCheckboxType,
  valueDropdownType: () => valueDropdownType,
  valueFileType: () => valueFileType,
  valuePillTextType: () => valuePillTextType,
  valueRadioType: () => valueRadioType,
  valueTextType: () => valueTextType
});
...
var modifyAtIfExist = (E3) => {
  return (k, f) => (m) => {
    const result = (0, import_function.pipe)(m, M.modifyAt(E3)(k, f));
    switch (result._tag) {
      case "Some":
        return result.value;
      case "None":
...
// src/update.ts
var A6 = __toESM(require("fp-ts/lib/Array"), 1);
var M5 = __toESM(require("fp-ts/lib/Map"), 1);
var O4 = __toESM(require("fp-ts/lib/Option"), 1);
var import_function6 = require("fp-ts/lib/function");
...
var allSelectRequired = (inputs) => {
  const isAllChecked = (0, import_function3.pipe)(
    inputs,
    A3.map(([_, bool]) => bool),
    and
  );
...
var atLeastOneSelected = (inputs) => {
  const isOneSelected = (0, import_function3.pipe)(
    inputs,
    A3.map(([_, bool]) => bool),
    or
  );
...
var notTheSameExtraValidation = (initialForms) => (forms) => {
  const extractValue = (form) => (0, import_function3.pipe)(
    form,
...
var runValidationForAll = (forms, extraValidation) => {
  const isAllFieldValid = (0, import_function3.pipe)(
    forms,
    M3.mapWithIndex((_, val) => {
      switch (val._tag) {
        case "TextType": {
...
var textPillMsgHandler = (msg, form) => {
  switch (msg._tag) {
    ...
    case "RemovePill":
      return {
        ...form,
        allValues: (0, import_function6.pipe)(
          form.allValues,
          A6.deleteAt(msg.index),
  ...
  switch (msg._tag) {
    case "UpdateForm": {
      if (msg.event && msg.event.target) {
        const newForm = (0, import_function6.pipe)(
          model.forms,
          modifyAtIfExist(S6.Eq)(msg.key, (form) => {
    ...
    case "UpdateCalendar": {
      if (msg.value) {
        const newForms = (0, import_function6.pipe)(
          model.forms,
          modifyAtIfExist(S6.Eq)(msg.key, (form) => {
      ...
      const newForms = (0, import_function6.pipe)(
        ...
        modifyAtIfExist(S6.Eq)(msg.key, (form) => {
          if (form._tag === "CheckboxType")
            return {
              ...form,
              currentValues: (0, import_function6.pipe)(
                form.currentValues,
                A6.map(([key, value]) => [
                  key,
          ...
          if (form._tag === "RadioType") {
            if (msg.allowUnselected) {
              if (form.currentValue._tag === "Some" && form.currentValue.value === msg.radio_key)
                return {
                  ...form,
                  currentValue: O4.none
                };
              else
                return {
                  ...form,
                  currentValue: O4.some(msg.radio_key)
                };
            } else
              return {
                ...form,
    ...
    case "RemoveFile": {
      const newForms = (0, import_function6.pipe)(
        ...
        modifyAtIfExist(S6.Eq)(msg.key, (form) => {
          if (form._tag === "FileType") {
            const result = (0, import_function6.pipe)(form.currentValues, A6.deleteAt(msg.index));
            return {
              ...form,
    ...
    case "HandleFocus": {
      const newForms = (0, import_function6.pipe)(
        model.forms,
        modifyAtIfExist(S6.Eq)(msg.key, (formType) => {
    ...
    case "AddFormItem": {
      ...
      const newForms = (0, import_function6.pipe)(model.forms, M5.upsertAt(S6.Eq)(key, formItem));
      return { ...model, forms: newForms };
    }
    case "RemoveFormItem": {
      const newForms = (0, import_function6.pipe)(model.forms, M5.deleteAt(S6.Eq)(msg.value));
      return { ...model, forms: newForms };
    }
  }
};
